...
import { fetchfundraisingEdit } from "../../feature/website/fundraising/fundraisingApi";
import { fetchFundraisingDetailsAsync, fetchfundraisingEditAsync, openEditModalFunc } from "../../feature/website/fundraising/fundraisingSlice";
...
export const AboutEditMOdal = ({
  ...
  const EditData = (e) => {
    ...
    dispatch(
      fetchfundraisingEditAsync(formData)
    );
