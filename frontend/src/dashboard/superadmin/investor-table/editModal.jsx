...
import { enable_edit_modal } from "../../../feature/dashboard/investors/investorDataSlice";
...
export const EditTable = () => {
    ...
    return (
        <>
            <div className="py-12 transition duration-150 ease-in-out z-10 absolute top-20 right-0 bottom-0 left-0">
                <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                        ...
                        <h1 className="text-gray-800 font-lg font-bold tracking-normal leading-tight mb-4">Update Investor Details</h1>
                        <label for="name" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Status</label>
                        ...
                        <label for="email2" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Role</label>
                        ...
                        <button onClick={() => dispatch(enable_edit_modal())} className="cursor-pointer absolute top-0 right-0 mt-4 mr-5 text-gray-400 hover:text-gray-600 transition duration-150 ease-in-out rounded focus:ring-2 focus:outline-none focus:ring-gray-600" aria-label="close modal" role="button">
