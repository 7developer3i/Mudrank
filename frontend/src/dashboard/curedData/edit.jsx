...
import { deleteModalfunc, editModalfunc, fetchCuratedEditAsync, fetchcuratedDetailsAsync } from "../../feature/website/curedpage/curedSlice";
import Cookies from "js-cookie";
import AuthContext from "../../context/AuthContext";

export const Editcured = ({
  setEditData,
  title,
  text,
  setText,
      ...
      >
        <div class="relative w-full max-w-md max-h-full">
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button
              onClick={() => {dispatch(editModalfunc)}}
              type="button"
