...
import { fetchAboutDeleteAsync, fetchAboutDetailsAsync, openDeletemodalfunc, openEditmodalfunc } from "../../feature/website/about/aboutSlice";
import Cookies from "js-cookie";
import AuthContext from "../../context/AuthContext";
import { openDeleteModalFunc } from "../../feature/website/privacy/privacySlice";

export const AboutDelete = ({ id, setDeleteModal }) => {
  const { adminid } = useContext(AuthContext)
  const dispatch = useDispatch()
  const { setAboutData } = useContext(WebsiteContext);
  const handleDelete = () => {
    const token = Cookies.get("admin_token")
    dispatch(fetchAboutDeleteAsync({ id,token, adminid }));
