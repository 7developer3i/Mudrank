...
import { fetchFreqDetailsAsync, fetchFreqEditAsync, openEditModalFunc } from "../../feature/website/frequentlyasked/frequentlySlice";
import Cookies from "js-cookie";
import AuthContext from "../../context/AuthContext";

export const FreqEditMOdal = ({
  openfreqEditModal,
  setOpenfreqEditModal,
  question,
  setQuestion,
  answer,
  setAnswer,
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
              <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                Update FrequentlyAskedTable Details
              </h3>
